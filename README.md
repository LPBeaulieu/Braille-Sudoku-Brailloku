...
- You can also opt for a truncated version of the sudoku grid (excluding some of the header text as well as the topmost and lowest horizontal
  delimiters, bringing the number of lines per page down to 18 lines, which allows for embossing on A4 paper in landscape mode. 
